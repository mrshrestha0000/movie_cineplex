...
def create_thirdparty_token(details : thirdparty_token_schema, db: Session = Depends(get_db)):
    try:

        thirdparty_user_model = db.query(thirdparty_models.thirdparty_user_model).filter(thirdparty_models.thirdparty_user_model.api_username == details.api_username).first()
        ...
        if details.api_username == thirdparty_user_model.api_username and details.api_password == thirdparty_user_model.api_password and details.api_secret == thirdparty_user_model.api_secret:
